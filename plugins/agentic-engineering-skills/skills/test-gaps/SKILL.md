...
```bash
npx @claude-flow/cli@3.7.0-alpha.5 hooks coverage-gaps --format table --limit 20
npx @claude-flow/cli@3.7.0-alpha.5 hooks coverage-route --task "add auth tests"
npx @claude-flow/cli@3.7.0-alpha.5 hooks coverage-suggest --path src/
```
